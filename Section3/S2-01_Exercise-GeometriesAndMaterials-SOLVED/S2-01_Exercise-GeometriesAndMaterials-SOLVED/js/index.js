...
var geometry = new THREE.RingBufferGeometry( 10, 50, 32 );
...
var texture = new THREE.TextureLoader().load('textures/p.jpg');
...
mesh4.position.x = 80;
mesh4.position.y = 160;

var mesh5 = new THREE.Mesh( geometry, material8 );
...
var mesh7 = new THREE.Mesh( geometry, material3 );
...
mesh8.position.x = -160;
mesh8.position.y = -80;

var mesh9 = new THREE.Mesh( geometry, material1 );
mesh9.position.z = -800;
mesh9.position.x = 800;
mesh9.position.y = 0;

var mesh10 = new THREE.Mesh( geometry, material8 );
mesh10.position.z = -1000;
mesh10.position.x = 160;
mesh10.position.y = -800;

var mesh11 = new THREE.Mesh( geometry, material8 );
mesh11.position.z = -800;
mesh11.position.x = -80;
mesh11.position.y = -200;

var mesh12 = new THREE.Mesh( geometry, material8 );
